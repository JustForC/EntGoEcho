...
func (ec *EmployeeCreate) SetSalary(i int32) *EmployeeCreate {
	ec.mutation.SetSalary(i)
	return ec
}
...
func (ec *EmployeeCreate) check() error {
	...
	if _, ok := ec.mutation.Salary(); !ok {
		return &ValidationError{Name: "salary", err: errors.New(`ent: missing required field "Employee.salary"`)}
	}
